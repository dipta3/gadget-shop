...
const Info = () => {
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 px-5'>
            ...
            <InfoCard cardTitle="Our Location" cardDes="Ahmend Nagar, Paikpara, Mirpur-1" bgClass="Pastel bg-gradient-to-tr from-violet-500 to-orange-300" img={infopic2}></InfoCard>
            <InfoCard cardTitle="Contract Us" cardDes={`diptabiswas79@gmail.com`} cardContract="017XXXXXXXX" bgClass="bg-gradient-to-r from-indigo-300 to-purple-400" img={infopic3}></InfoCard>
        </div>
    );
};
